...
<div id="accordion" class="accordionStyle">
    ...
    <div class="card">
        <div class="card-header" id="h_unidad_intro">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#unidad_intro"
                    aria-expanded="false" aria-controls="unidad_intro">
                    Intro Curso
                </button>
            </h5>
        </div>
        <div id="unidad_intro" class="collapse <?php if($unidad_intro == 0){ echo "show"; } ?>"
            aria-labelledby="h_unidad_intro" data-parent="#accordion">
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <button class="button finalizar_intro" type="submit"
                        style="font-size: 15px; margin: 25px 0px; background: #b05ad4c2; color: #FFFFFF;">¡Comenzar el
                        curso!</button>
                </form>
                <?php } ?>
    ...
    <div class="card">
        <div class="card-header" id="h_unidad_01">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed unidad_01" <?php if(!$status["unidad_1"]){ echo "disabled"; } ?>
                    data-toggle="collapse" data-target="#unidad_01" aria-expanded="false" aria-controls="unidad_01">
                    Unidad 01 
                    <?php 
                    if($finish){
                        echo "<button class='attempVideo' data-n-unidad='1' data-type='1' data-ids='1-".get_the_ID()."-".getDataSession('id')."' style='font-size: 12px;color: #4f2acb;background: #f3c7ff;padding: 5px 11px;padding-bottom: 4px;border-radius: 23px;margin-left: 6px;position: relative;top: -2px; border: none;'>Ver video nuevamente</button>";
                    } 
                    ?>
                </button>
            </h5>
        </div>
        <div id="unidad_01" class="collapse <?php if(isset($closeAll)){ } else { if($actual == 1){ echo "show"; } } ?>"
            aria-labelledby="h_unidad_01" data-parent="#accordion">
            <div class="card-body">
                <?php echo getPreguntasUnidad(1); ?>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-header" id="h_unidad_02">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed unidad_02" <?php if(!$status["unidad_2"]){ echo "disabled"; } ?>
                    data-toggle="collapse" data-target="#unidad_02" aria-expanded="false" aria-controls="unidad_02">
                    Unidad 02
                    <?php 
                    if($finish){
                        echo "<button class='attempVideo' data-n-unidad='2' data-type='1' data-ids='2-".get_the_ID()."-".getDataSession('id')."' style='font-size: 12px;color: #4f2acb;background: #f3c7ff;padding: 5px 11px;padding-bottom: 4px;border-radius: 23px;margin-left: 6px;position: relative;top: -2px; border: none;'>Ver video nuevamente</button>";
                    } 
                    ?>
                </button>
            </h5>
        </div>
        <div id="unidad_02" class="collapse <?php if(isset($closeAll)){ } else { if($actual == 2){ echo "show"; } } ?>"
            aria-labelledby="h_unidad_02" data-parent="#accordion">
            <div class="card-body">
                <?php echo getPreguntasUnidad(2); ?>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-header" id="h_unidad_03">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed unidad_03" <?php if(!$status["unidad_3"]){ echo "disabled"; } ?>
                    data-toggle="collapse" data-target="#unidad_03" aria-expanded="false" aria-controls="unidad_03">
                    Unidad 03
                    <?php 
                    if($finish){
                        echo "<button class='attempVideo' data-n-unidad='3' data-type='1' data-ids='3-".get_the_ID()."-".getDataSession('id')."' style='font-size: 12px;color: #4f2acb;background: #f3c7ff;padding: 5px 11px;padding-bottom: 4px;border-radius: 23px;margin-left: 6px;position: relative;top: -2px; border: none;'>Ver video nuevamente</button>";
                    } 
                    ?>
                </button>
            </h5>
        </div>
        <div id="unidad_03" class="collapse <?php if(isset($closeAll)){ } else { if($actual == 3){ echo "show"; } } ?>"
            aria-labelledby="h_unidad_03" data-parent="#accordion">
            <div class="card-body">
                <?php echo getPreguntasUnidad(3); ?>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-header" id="h_unidad_04">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed unidad_04" <?php if(!$status["unidad_4"]){ echo "disabled"; } ?>
                    data-toggle="collapse" data-target="#unidad_04" aria-expanded="false" aria-controls="unidad_04">
                    Unidad 04
                    <?php 
                    if($finish){
                        echo "<button class='attempVideo' data-n-unidad='4' data-type='1' data-ids='4-".get_the_ID()."-".getDataSession('id')."' style='font-size: 12px;color: #4f2acb;background: #f3c7ff;padding: 5px 11px;padding-bottom: 4px;border-radius: 23px;margin-left: 6px;position: relative;top: -2px; border: none;'>Ver video nuevamente</button>";
                    } 
                    ?>
                </button>
            </h5>
        </div>
        <div id="unidad_04" class="collapse <?php if(isset($closeAll)){ } else { if($actual == 4){ echo "show"; } } ?>"
            aria-labelledby="h_unidad_04" data-parent="#accordion">
            <div class="card-body">
                <?php echo getPreguntasUnidad(4); ?>
            </div>
        </div>
    </div>
    ...
    <div class="card" id="f_course">
        ...
        <p id="load_finish" style="display:none; font-size: 13px; margin: 10px; color: #3ca4ce; font-family: inherit;">
            <img src="<?php echo get_template_directory_uri(); ?>/images/loading.svg"
                style="width: 20px; margin-right: 7px;" /> Actualizando estado...
        </p>
