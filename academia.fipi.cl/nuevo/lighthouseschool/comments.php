				...
				$lighthouseschool_comments_args = apply_filters( 'lighthouseschool_filter_comment_form_args', array(
						...
						'fields' => array(
							'author' => lighthouseschool_single_comments_field(array(
												...
												'field_name' => 'author',
												'field_title' => esc_attr__('Name', 'lighthouseschool'),
												'field_placeholder' => esc_attr__( 'Your Name', 'lighthouseschool' )
											)),
							'email' => lighthouseschool_single_comments_field(array(
												...
												'field_name' => 'email',
												'field_title' => esc_attr__('E-mail', 'lighthouseschool'),
												'field_placeholder' => esc_attr__( 'Your E-mail', 'lighthouseschool' )
											))
						),
						...
						'comment_field' => lighthouseschool_single_comments_field(array(
												...
												'field_value' => '',
												'field_name' => 'comment',
												'field_title' => esc_attr__('Comment', 'lighthouseschool'),
												'field_placeholder' => esc_attr__( 'Your comment', 'lighthouseschool' )
											)),
				));
