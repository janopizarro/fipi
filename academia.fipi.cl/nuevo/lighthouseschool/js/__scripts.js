...
(function(){
	...
	if (typeof LIGHTHOUSESCHOOL_STORAGE == 'undefined') window.LIGHTHOUSESCHOOL_STORAGE = {};
	
	// Get global variable
	window.lighthouseschool_storage_get = function(var_name) {
		return lighthouseschool_isset(LIGHTHOUSESCHOOL_STORAGE[var_name]) ? LIGHTHOUSESCHOOL_STORAGE[var_name] : '';
	};
	
	// Set global variable
	window.lighthouseschool_storage_set = function(var_name, value) {
		LIGHTHOUSESCHOOL_STORAGE[var_name] = value;
	};
	
	// Inc/Dec global variable with specified value
	window.lighthouseschool_storage_inc = function(var_name) {
		var value = arguments[1]===undefined ? 1 : arguments[1];
		LIGHTHOUSESCHOOL_STORAGE[var_name] += value;
	};
	
	// Concatenate global variable with specified value
	window.lighthouseschool_storage_concat = function(var_name, value) {
		LIGHTHOUSESCHOOL_STORAGE[var_name] += ''+value;
	};
	
	// Get global array element
	window.lighthouseschool_storage_get_array = function(var_name, key) {
		return lighthouseschool_isset(LIGHTHOUSESCHOOL_STORAGE[var_name][key]) ? LIGHTHOUSESCHOOL_STORAGE[var_name][key] : '';
	};
	
	// Set global array element
	window.lighthouseschool_storage_set_array = function(var_name, key, value) {
		if (!lighthouseschool_isset(LIGHTHOUSESCHOOL_STORAGE[var_name])) LIGHTHOUSESCHOOL_STORAGE[var_name] = {};
		LIGHTHOUSESCHOOL_STORAGE[var_name][key] = value;
	};
	
	// Inc/Dec global array element with specified value
	window.lighthouseschool_storage_inc_array = function(var_name, key) {
		var value = arguments[2]===undefined ? 1 : arguments[2];
		LIGHTHOUSESCHOOL_STORAGE[var_name][key] += value;
	};
	
	// Concatenate global array element with specified value
	window.lighthouseschool_storage_concat_array = function(var_name, key, value) {
		LIGHTHOUSESCHOOL_STORAGE[var_name][key] += ''+value;
	};
	...
	/* PHP-style functions
	---------------------------------------------------------------- */
	window.lighthouseschool_isset = function(obj) {
		return typeof(obj) != 'undefined';
	};
	
	window.lighthouseschool_empty = function(obj) {
		return typeof(obj) == 'undefined' || (typeof(obj)=='object' && obj == null) || (typeof(obj)=='array' && obj.length == 0) || (typeof(obj)=='string' && lighthouseschool_alltrim(obj)=='') || obj===0;
	};
	
	window.lighthouseschool_is_array = function(obj)  {
		return typeof(obj)=='array';
	};
	
	window.lighthouseschool_is_object = function(obj)  {
		return typeof(obj)=='object';
	};
	
	window.lighthouseschool_clone_object = function(obj) {
		if (obj == null || typeof(obj) != 'object') {
			return obj;
		}
		var temp = {};
		for (var key in obj) {
			temp[key] = lighthouseschool_clone_object(obj[key]);
		}
		return temp;
	};
	
	window.lighthouseschool_merge_objects = function(obj1, obj2)  {
		for (var i in obj2) obj1[i] = obj2[i];
		return obj1;
	};
	
	// Generates a storable representation of a value
	window.lighthouseschool_serialize = function(mixed_val) {
			...
			case "object":
				if (mixed_val == null)
					...
					for (var i=0; i<mixed_val.length; i++) {
						idxobj.idx++;
						var ser = lighthouseschool_serialize(mixed_val[i]);
						if (ser)
							map.push(lighthouseschool_serialize(idxobj.idx) + ser);
					}                                      
					return "a:" + mixed_val.length + ":{" + map.join("") + "}";
				} else {
					var class_name = lighthouseschool_get_class(mixed_val);
					if (class_name == undefined)
						return false;
					var props = new Array();
					for (var prop in mixed_val) {
						var ser = lighthouseschool_serialize(mixed_val[prop]);
						if (ser)
							props.push(lighthouseschool_serialize(prop) + ser);
					}
					if (obj_to_array)
	...
	window.lighthouseschool_get_class = function(obj) {
	...
	window.lighthouseschool_in_list = function(str, list) {
	...
	window.lighthouseschool_alltrim = function(str) {
	...
	window.lighthouseschool_ltrim = function(str) {
		return lighthouseschool_alltrim(str, 'l');
	};
	
	window.lighthouseschool_rtrim = function(str) {
		return lighthouseschool_alltrim(str, 'r');
	};
	
	window.lighthouseschool_padl = function(str, len) {
	...
	window.lighthouseschool_padr = function(str, len) {
		var ch = arguments[2]!==undefined ? arguments[2] : ' ';
		var rez = str.substr(0,len);
		if (rez.length < len) {
			for (var i=0; i<len-str.length; i++)
	...
	window.lighthouseschool_padc = function(str, len) {
		var ch = arguments[2]!==undefined ? arguments[2] : ' ';
		var rez = str.substr(0,len);
		if (rez.length < len) {
	...
	window.lighthouseschool_replicate = function(str, num) {
		var rez = '';
		for (var i=0; i<num; i++) {
			rez += str;
		}
	...
	window.lighthouseschool_prepare_macros = function(str) {
		return str
			.replace(/\{\{/g, "<i>")
			.replace(/\}\}/g, "</i>")
			.replace(/\[\[/g, "<b>")
	...
	window.lighthouseschool_round_number = function(num) {
	...
	window.lighthouseschool_clear_number = function(num) {
		var precision = arguments[1]!==undefined ? arguments[1] : 0;
	...
	window.lighthouseschool_dec2hex = function(n) { 
		return Number(n).toString(16);
	};
	
	// Convert number from hex to decimal
	window.lighthouseschool_hex2dec = function(hex) {
	...
	window.lighthouseschool_in_array = function(val, thearray)  {
		var rez = false;
	...
	window.lighthouseschool_sort_array = function(thearray)  {
	...
	window.lighthouseschool_parse_date = function(dt) {
	...
	window.lighthouseschool_get_date_difference = function(dt1) {
		var dt2 = arguments[1]!==undefined ? arguments[1] : '';
		var short_date = arguments[2]!==undefined ? arguments[2] : true;
		var sec = arguments[3]!==undefined ? arguments[3] : false;
		var a1 = lighthouseschool_parse_date(dt1);
		dt1 = Date.UTC(a1[0], a1[1], a1[2], a1[3], a1[4], a1[5]);
		if (dt2 == '') {
			dt2 = new Date();
			var a2 = [dt2.getFullYear(), dt2.getMonth()+1, dt2.getDate(), dt2.getHours(), dt2.getMinutes(), dt2.getSeconds()];
		} else
			var a2 = lighthouseschool_parse_date(dt2);
	...
	window.lighthouseschool_hex2rgb = function(hex) {
		hex = parseInt(((hex.indexOf('#') > -1) ? hex.substring(1) : hex), 16);
		return {r: hex >> 16, g: (hex & 0x00FF00) >> 8, b: (hex & 0x0000FF)};
	};

	window.lighthouseschool_hex2rgba = function(hex, alpha) {
		var rgb = lighthouseschool_hex2rgb(hex);
		return 'rgba('+rgb.r+','+rgb.g+','+rgb.b+','+alpha+')';
	};

	window.lighthouseschool_rgb2hex = function(color) {
		var aRGB;
	...
	window.lighthouseschool_components2hex = function(r,g,b) {
		return '#'+
	...
	window.lighthouseschool_rgb2components = function(color) {
		color = lighthouseschool_rgb2hex(color);
	...
	window.lighthouseschool_hex2hsb = function(hex) {
		var h = arguments[1]!==undefined ? arguments[1] : 0;
		var s = arguments[2]!==undefined ? arguments[2] : 0;
		var b = arguments[3]!==undefined ? arguments[3] : 0;
		var hsb = lighthouseschool_rgb2hsb(lighthouseschool_hex2rgb(hex));
	...
	window.lighthouseschool_hsb2hex = function(hsb) {
		var rgb = lighthouseschool_hsb2rgb(hsb);
		return lighthouseschool_components2hex(rgb.r, rgb.g, rgb.b);
	};
	
	window.lighthouseschool_rgb2hsb = function(rgb) {
		var hsb = {};
	...
	window.lighthouseschool_hsb2rgb = function(hsb) {
		var rgb = {};
	...
	window.lighthouseschool_color_picker = function(){
		...
		jQuery(document.createElement("div"))
			...
			.on('mouseover', 'thead td', function(){
				var aaa = lighthouseschool_rgb2hex(jQuery(this).css('background-color'));
			...
			.on('click', 'tbody .iColorPicker_moreColors', function(e){
				...
				if (thead.hasClass('more_colors')) {
					...
					while (rgb[0]<0xF || rgb[1]<0xF || rgb[2]<0xF) {
						...
						i++;
						out += '<td style="background-color:'+lighthouseschool_components2hex(rgb[0]*16+rgb[0],rgb[1]*16+rgb[1],rgb[2]*16+rgb[2])+'">&nbsp;</td>';
						rgb[2]+=3;
						if (rgb[2]>0xF) {
							rgb[1]+=3;
							if (rgb[1]>(j===0 ? 6 : 0xF)) {
	...
	window.lighthouseschool_color_picker_show = function(id, fld, func) { 
		if (id===null || id==='') {
		...
		jQuery("#"+id+"_Bg")
			...
			.fadeIn(500);
		var def = fld.val().substr(0, 1)=='#' ? fld.val() : lighthouseschool_rgb2hex(fld.css('backgroundColor'));
	...
	window.lighthouseschool_get_cookie = function(name) {
	...
	window.lighthouseschool_set_cookie = function(name, value) {
	...
	window.lighthouseschool_del_cookie = function(name, path, domain) {
		var path   = arguments[1]!==undefined ? arguments[1] : '/';
		var domain = arguments[2]!==undefined ? arguments[2] : '';
		if (lighthouseschool_get_cookie(name))
	...
	window.lighthouseschool_clear_listbox = function(box) {
		for (var i=box.options.length-1; i>=0; i--)
			box.options[i] = null;
	};
	
	window.lighthouseschool_add_listbox_item = function(box, val, text) {
		var item = new Option();
		item.value = val;
		item.text = text;
	...
	window.lighthouseschool_del_listbox_item_by_value = function(box, val) {
	...
	window.lighthouseschool_del_listbox_item_by_text = function(box, txt) {
		for (var i=0; i<box.options.length; i++) {
	...
	window.lighthouseschool_find_listbox_item_by_value = function(box, val) {
		var idx = -1;
		for (var i=0; i<box.options.length; i++) {
			if (box.options[i].value == val) {
				idx = i;
	...
	window.lighthouseschool_find_listbox_item_by_text = function(box, txt) {
		var idx = -1;
		for (var i=0; i<box.options.length; i++) {
			if (box.options[i].text == txt) {
				idx = i;
	...
	window.lighthouseschool_select_listbox_item_by_value = function(box, val) {
		for (var i = 0; i < box.options.length; i++) {
			box.options[i].selected = (val == box.options[i].value);
		}
	};
	
	window.lighthouseschool_select_listbox_item_by_text = function(box, txt) {
		for (var i = 0; i < box.options.length; i++) {
			box.options[i].selected = (txt == box.options[i].text);
		}
	};
	
	window.lighthouseschool_get_listbox_values = function(box) {
	...
	window.lighthouseschool_get_listbox_texts = function(box) {
		var delim = arguments[1]!==undefined ? arguments[1] : ',';
		var str = '';
		for (var i=0; i<box.options.length; i++) {
	...
	window.lighthouseschool_sort_listbox = function(box)  {
	...
	window.lighthouseschool_get_listbox_selected_index = function(box) {
		for (var i = 0; i < box.options.length; i++) {
	...
	window.lighthouseschool_get_listbox_selected_value = function(box) {
		for (var i = 0; i < box.options.length; i++) {
			if (box.options[i].selected) {
	...
	window.lighthouseschool_get_listbox_selected_text = function(box) {
		for (var i = 0; i < box.options.length; i++) {
			if (box.options[i].selected) {
	...
	window.lighthouseschool_get_listbox_selected_option = function(box) {
		for (var i = 0; i < box.options.length; i++) {
			if (box.options[i].selected) {
	...
	window.lighthouseschool_get_radio_value = function(radioGroupObj) {
		for (var i=0; i < radioGroupObj.length; i++)
			if (radioGroupObj[i].checked) return radioGroupObj[i].value;
		return null;
	};
	
	window.lighthouseschool_set_radio_checked_by_num = function(radioGroupObj, num) {
		for (var i=0; i < radioGroupObj.length; i++)
			if (radioGroupObj[i].checked && i!=num) radioGroupObj[i].checked=false;
			else if (i==num) radioGroupObj[i].checked=true;
	};
	
	window.lighthouseschool_set_radio_checked_by_value = function(radioGroupObj, val) {
		for (var i=0; i < radioGroupObj.length; i++)
	...
	window.lighthouseschool_form_validate = function(form, opt) {
		var error_msg = '';
	...
	window.lighthouseschool_document_animate_to = function(id, callback) {
		...
		var oft2 = Math.max(0, oft - lighthouseschool_fixed_rows_height());
		var speed = Math.min(1200, Math.max(300, Math.round(Math.abs(oft2-st) / jQuery(window).height() * 300)));
		if (st == 0) {
			setTimeout(function() {
				if (isNaN(id)) oft = obj.offset().top;
				oft2 = Math.max(0, oft - lighthouseschool_fixed_rows_height());
	...
	window.lighthouseschool_fixed_rows_height = function() {
	...
	window.lighthouseschool_document_set_location = function(curLoc){
		try {
	...
	window.lighthouseschool_add_to_url = function(loc, prm) {
	...
	window.lighthouseschool_is_local_link = function(url) {
	...
	window.lighthouseschool_browser_is_mobile = function() {
		var check = false;
	...
	window.lighthouseschool_browser_is_ios = function() {
		return navigator.userAgent.match(/iPad|iPhone|iPod/i) != null;
	};

	window.lighthouseschool_is_retina = function() {
	...
	window.lighthouseschool_get_file_name = function(path) {
		path = path.replace(/\\/g, '/');
	...
	window.lighthouseschool_get_file_ext = function(path) {
		var pos = path.lastIndexOf('.');
	...
	window.lighthouseschool_check_images_complete = function(cont) {
		var complete = true;
	...
	/* Debug functions
	---------------------------------------------------------------- */
	window.lighthouseschool_debug_object = function(obj) {
		...
		if (level > 0) {
			...
			addStr = lighthouseschool_replicate(' ', level*2);
		}
		if (obj!==null && (typeof(obj)=='object' || typeof(obj)=='array')) {
			for (var prop in obj) {
				...
				if (level<recursive && (typeof(obj[prop])=='object' || typeof(obj[prop])=='array') && obj[prop]!=obj)
					dispStr += addStr + prop + '=' + lighthouseschool_debug_object(obj[prop], recursive, showMethods, level+1);
				else {
					try {
						curStr = "" + obj[prop];
					} catch (e) {
	...
	window.lighthouseschool_debug_log = function(s) {
		if (LIGHTHOUSESCHOOL_STORAGE['user_logged_in']) {
	...
	window.dco===undefined && (window.dco = function(s,r) { console.log(lighthouseschool_debug_object(s,r)); });
	window.dal===undefined && (window.dal = function(s) { if (LIGHTHOUSESCHOOL_STORAGE['user_logged_in']) alert(s); });
	window.dao===undefined && (window.dao = function(s,r) { if (LIGHTHOUSESCHOOL_STORAGE['user_logged_in']) alert(lighthouseschool_debug_object(s,r)); });
	window.ddl===undefined && (window.ddl = function(s) { lighthouseschool_debug_log(s); });
	window.ddo===undefined && (window.ddo = function(s,r) { lighthouseschool_debug_log(lighthouseschool_debug_object(s,r)); });
