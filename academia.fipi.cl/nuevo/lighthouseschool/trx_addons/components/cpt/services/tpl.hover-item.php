...
<div class="sc_services_item<?php
	...
	echo esc_html($args['featured']=='icon' ? ' with_icon' : '');
	echo esc_html($args['featured']=='number' ? ' with_number' : '');
?>">
	<div class="sc_services_item_header <?php echo esc_html($args['hide_bg_image']==1 ? ' without_image' : ''); ?>"<?php if ($args['hide_bg_image']==0 && !empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
