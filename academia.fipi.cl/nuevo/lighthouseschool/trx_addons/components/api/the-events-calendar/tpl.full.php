<?php
/**
 * The style "full" of the Tribe Events
 *
 * @package WordPress
...
if ($query->found_posts > 0) {
    $args = apply_filters( 'trx_addons_filter_sc_prepare_atts_before_output', $args, $query_args, $query, 'tribe_events.full' );
    ...
    ?><div class="sc_events sc_events_full<?php
...
if ($args['slider']) {
    ...
    while ( $query->have_posts() ) { $query->the_post();
        trx_addons_get_template_part(TRX_ADDONS_PLUGIN_API . 'the-events-calendar/tpl.full-item.php', 'trx_addons_args_sc_events', $args);
    }
