...
if ( !function_exists( 'lighthouseschool_woocommerce_get_css' ) ) {
	add_filter( 'lighthouseschool_filter_get_css', 'lighthouseschool_woocommerce_get_css', 10, 4 );
	function lighthouseschool_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.lighthouseschool_shop_mode_buttons a {
	color: {$colors['text']};
}

.shop_mode_thumbs .lighthouseschool_shop_mode_buttons  a.woocommerce_thumbs,
.shop_mode_list .lighthouseschool_shop_mode_buttons a.woocommerce_list {
	color: {$colors['text_dark']};
}

.lighthouseschool_shop_mode_buttons a:hover {
...
.woocommerce.widget_shopping_cart .quantity .amount, .woocommerce .widget_shopping_cart .quantity .amount, .woocommerce-page.widget_shopping_cart .quantity .amount, .woocommerce-page .widget_shopping_cart .quantity .amount {
	color: {$colors['text_hover']};
}
