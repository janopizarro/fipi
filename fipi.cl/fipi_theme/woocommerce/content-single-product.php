...
<div itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" id="product-<?php the_ID(); ?>" <?php post_class('single_product_inner_content'); ?>>
									...
									<div class="meta-unit teacher clearfix">
										...
										<div class="meta_values">
											<?php if( is_array($experts) ){ ?>
												<div class="label h6"><?php _e('Teachers', 'stm_domain'); ?></div>
	...
	<?php if( is_array($experts) ){ ?>
		<h3 class="teacher_single_product_page_title"><?php _e('About Instructors', 'stm_domain'); ?></h3>
		<?php foreach( $experts as $expert ){ ?>
			<!-- Teacher -->
		...
		<!-- Teacher -->
			...
			<div class="teacher_single_product_page clearfix">
				<a href="<?php echo get_the_permalink($experts); ?>" title="<?php _e('Watch Expert Page', 'stm_domain'); ?>">
